...
export class ProveedorService {
    ...
    get() {
      ...
      put( proveedor ) {
        const headers = new HttpHeaders({'Content-Type': 'application/json'});
        return this.httpClient.put(this.API_ENDPOINT + 'proveedor/' + proveedor.id_proveedores, proveedor, {headers: headers});

      }
      delete (id_proveedores) {
        return this.httpClient.delete(this.API_ENDPOINT + 'proveedor/' + id_proveedores);
      }
